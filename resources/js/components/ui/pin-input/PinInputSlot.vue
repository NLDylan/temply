...
<template>
  <PinInputInput
    ...
    v-bind="forwardedProps"
      :class="cn('border-input focus:border-ring focus:ring-ring/50 focus:aria-invalid:ring-destructive/20 dark:bg-input/30 dark:focus:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus:aria-invalid:border-destructive relative flex h-9 w-9 items-center justify-center border-y border-r border-border bg-card text-sm transition-all outline-none text-center first:rounded-l-md first:border-l first:border-border last:rounded-r-md focus:z-10 focus:ring-[3px]', props.class)"
  />
</template>
