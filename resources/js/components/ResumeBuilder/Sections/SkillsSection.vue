...
<template>
  ...
  >
    <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr),320px]">
      <div class="grid gap-6">
        ...
        <div class="grid gap-4">
          <Card
            ...
            :key="category"
            class="border-border/60 bg-background/95"
          >
            <CardHeader class="flex flex-col gap-2 border-b border-border/60 sm:flex-row sm:items-center sm:justify-between">
            ...
            <CardContent class="grid gap-3 pt-4">
              <div
                ...
                :key="skill.id"
                class="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border/40 bg-muted/20 px-4 py-3"
              >
      ...
      <aside class="grid gap-4 rounded-2xl border border-border/60 bg-muted/20 p-4">
        <p class="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
          Add a new skill
        </p>
        <div class="grid gap-3 rounded-xl border border-dashed border-border/60 bg-background/80 p-4">
        ...
        <div class="rounded-xl border border-border/60 bg-background/80 p-4 text-xs text-muted-foreground">
